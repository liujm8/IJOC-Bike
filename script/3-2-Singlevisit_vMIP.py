...
writer=csv.writer(open('../results/SmallCase-result-MILP-singlevisit/result_'+str(veh_n)+'_'+file_name,'w',newline=''))
...
#         for j in range(-2,n):
#             if i!=j:
#                 diss=diss+distance_sphere(points[i], points[j])*vars[v,i,j].x
